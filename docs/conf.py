...
MOCK_MODULES = [
        ...
        'lightning', 'sklearn-contrib-lightning',
        'sklearn.metrics.pairwise',
        'seaborn', 'pysam', 'xgboost', "pillow",
        ]
...
copyright = u'2018, Simon van Heeringen, licensed under CC BY 4.0'
...
htmlhelp_basename = 'GimmeMotifsdoc'
...
latex_documents = [
  ('index', 'GimmeMotifs.tex', u'GimmeMotifs Documentation',
...
man_pages = [
    ('index', 'gimmemotifs', u'GimmeMotifs Documentation',
...
texinfo_documents = [
  ('index', 'GimmeMotifs', u'GimmeMotifs Documentation',
   u'Simon van Heeringen', 'GimmeMotifs', 'One line description of project.',
   'Miscellaneous'),
]
