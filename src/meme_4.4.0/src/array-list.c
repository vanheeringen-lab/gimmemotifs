 ...
 * and the item that was at index is returned.
 */
void *arraylst_remove_range(int index, int count, ARRAYLST_T *arraylst) {
  // test parameters
  ...
  void* item = arraylst->array[index];
...
void arraylst_clear(ARRAYLST_T *arraylst) {
  ...
  if (arraylst->size > 0) arraylst_remove_range(0, arraylst->size, arraylst);
}
...
void *arraylst_remove(int index, ARRAYLST_T *arraylst) {
  return arraylst_remove_range(index, 1, arraylst);
}
...
void *arraylst_take(ARRAYLST_T *arraylst) {
  ...
  return arraylst_remove_range(arraylst->size-1, 1, arraylst);
}
