 ...
 *************************************************************************/
inline int ranksum_data_cmp(const void *v1, const void *v2)
{
  assert(v1 != NULL);
  assert(v2 != NULL);
  RSDP_T* s1 = *(RSDP_T **)v1;
 ...
 */
inline double double_array_get(const void *array, int index) {
  return ((double*)array)[index];
}
inline BOOLEAN_T boolean_array_get(const void *array, int index) {
