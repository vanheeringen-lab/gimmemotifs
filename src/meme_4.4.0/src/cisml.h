...
/**********************************************************************
  ...
  It fails if the new max is smaller then the current max_stored_matches.
...
/**********************************************************************
  get_pattern_num_scanned_elements

  Gets the number of sites scanned with a cisml pattern object.
**********************************************************************/
int get_pattern_num_scanned_elements(PATTERN_T *pattern);
...
/**********************************************************************
  get_scanned_sequence_num_scanned_elements

  Gets the number of positions in the scanned_sequence where we
  have scanned for a matched_element.
**********************************************************************/
int get_scanned_sequence_num_scanned_elements(SCANNED_SEQUENCE_T *sequence);
