/* ---------------------------- Header ---------------------------------
  ...
  Version:
    ...
    $Id: ceqlogo.h 4278 2009-12-23 09:58:37Z james_johnson $
...
/*
  ...
  Example       :
    LP_PARAMS_T* params = LP_create();
      LP_add_line(params, mat1, 0, "ACTG", 0, NULL);
      LP_add_line(params, mat2, 0, "ACTG", 0, "Query");
      LP_add_line(params, mat3, 0, "ACTG", 1, "Target");
    LP_free(params);
*/
...
/*
  ...
  Example       :
    SVG_init(params, "NA");
      SVG_add(params, mat1, 0, "ACTG", 0, NULL);
      SVG_add(params, mat2, 0, "ACTG", 0, "label");
      SVG_add(params, mat3, 1, "ACTG", 2, NULL);
    SVG_exit(params, fout);
*/
...
/*
  ...
  Example       :
    EPS_init(params, "NA");
      EPS_add(params, mat1, 0, "ACTG", 0, NULL);
      EPS_add(params, mat2, 0, "ACTG", 0, "Query");
      EPS_add(params, mat3, 0, "ACTG", 1, "Target");
    EPS_exit(params, fout);
*/
...
/*
  ...
  Example       :
    FILE* fout = F_open("output.eps", "w");
      EPS_init(params, "NA");
        EPS_add(params, mat, 0, "ACTG", 0, NULL);
      EPS_exit(params, fout);
    F_close(fout);
*/
