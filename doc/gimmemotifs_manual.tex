...
\begin{itemize}
\item van Heeringen SJ and Veenstra GJC, GimmeMotifs: a \textit{de novo} motif prediction pipeline for ChIP-sequencing experiments, \textit{submitted}.
\end{itemize}
This document describes how to install and use GimmeMotifs, for theoretical details, please see our publication \citetext{van Heeringen \textit{et al.}, submitted}.
...
\item MotifSampler \cite{thijs_higher-order_2001} \url{http://homes.esat.kuleuven.be/~sistawww/bioi/thijs/download.html}
\end{itemize}
