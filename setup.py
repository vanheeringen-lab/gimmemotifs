...
data_files=[
    ...
    ('gimmemotifs/motif_databases', [
                                    ...
                                    'motif_databases/vertebrate_clusters.pwm',
                                    'motif_dababases/gimme.invertebrate.v1.0.pwm',
                                    'motif_dababases/gimme.vertebrate.v3.1.pwm',
                                    'motif_dababases/gimme.vertebrate.v3.1.factor2motifs.txt',
                                    'motif_dababases/gimme.vertebrate.v3.1.motif2factors.txt',
                                    ]),
